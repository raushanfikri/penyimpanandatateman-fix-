...
import controllerImplementasi.ImTeman;
 ...
 * @author microsoft
 */
public class VTeman extends javax.swing.JFrame {
List <MTeman> record = new ArrayList<>();
    ITeman fikriservice;
    int row;
    /**
     * Creates new form VTeman
     */
    public VTeman() {
        initComponents();
        fikriservice = new ImTeman();
        this.refresdata();
    }
private void baru() {
...
isitabel();
    ...
    private void initComponents() {
        ...
        setTitle("Form Penyimpanan Data Teman");
...
// JOptionPane.showMessageDialog(this,"Data gagaal ");
    ...
    private void jBTN_HAPUSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBTN_HAPUSActionPerformed
       ...
       // if(id.trim().equals("") && nama.trim().equals("")){
        ...
        //}else{
        try {
          fikriservice.hapus(jTBL_Teman.getValueAt(row, 0).toString());
...
System.out.println("Gagal Dihapus"+z);    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VTeman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
